...
public class BallPart2 extends Circle{ //makes a new class ball so that there can be many different balls inside the arraylist balls (it needs to extend circle so that each new ball created shows up on the display frame as a circle)
	//Properties of Ball:
	...
	/**
	 * This method gets the Beta value of the ball
	 * @return	returns the Beta value
	 */
	public double getB() {
		return B;
	}
	...
	/**
	 * This method changes the Beta value of the ball
	 * @param B		takes the Beta value and sets the variable B to this new value
	 */
	 ...
	 * @param B					The air resistance for each ball
	 */
	public BallPart2 (double positionX, double positionY, double accelerationX, double accelerationY, double velocityX, double velocityY, double velocityXNew, double velocityYNew, double B) {
